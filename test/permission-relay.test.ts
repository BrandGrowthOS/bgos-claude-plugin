 ...
 *
 * Every pin here stands for a way the relay was invisible before 0.47.0. The
...
test('the callback format matches the sentence this plugin tells its own agent', () => {
  ...
  // it was FALSE here until 0.47.0: the relay spoke perm:. Nothing pinned the
...
test('auto approve answers FIRST, above the drain, and posts nothing', () => {
  // Found in the second review. 0.47.0 put the new drain branch in front of
