...
import { mkdirSync, readFileSync, realpathSync, unlinkSync, writeFileSync, renameSync } from 'node:fs'
 ...
 */
export function resolvedPathOrNull(path, resolve = realpathSync) {
